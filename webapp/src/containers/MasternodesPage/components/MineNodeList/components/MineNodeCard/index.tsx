...
import { MASTER_NODES_PATH, MINIMUM_DFI_AMOUNT_FOR_MASTERNODE, SAME_AS_OWNER_ADDRESS } from 'src/constants';
        ...
        <CardBody>
          ...
          <Row className='mt-3'>
            ...
            <Col md='8'>
              <CardText>
                <small className='text-muted'>
                  <NumberMask value={MINIMUM_DFI_AMOUNT_FOR_MASTERNODE.toString()} />
                  <span> DFI</span>
                </small>
              </CardText>
            </Col>
