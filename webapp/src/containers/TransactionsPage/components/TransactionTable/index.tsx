...
import { getErrorMessage, getFormattedTime } from '../../../../utils/utility';
...
import TxnDropdown from 'src/components/TxnDropdown';
...
interface TransactionProps {
  ...
  setCsvModalOpen: (value: boolean | ((prevVar: boolean) => boolean)) => void;
  isOpen: boolean;
...
const TransactionTable: React.FunctionComponent<TransactionProps> = (
  ...
  useEffect(() => {
    ...
    getData();
  }, [reqData.limit, reqData.no_rewards, reqData.blockHeight, tokenSymbol]);
    ...
    <section className='mb-5'>
      <div className={styles.container}>
        <div className={styles.dropDown}>
          <h2>
            {I18n.t('containers.transaction.transactionPage.filterByAsset')}
          </h2>
        ...
        <div className='btn-group'>
          <FormGroup>
            <CustomInput
              ...
              id='includeRewards'
              label={I18n.t(
                'containers.transaction.transactionPage.includeRewards'
              )}
