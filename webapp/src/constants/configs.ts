...
export const SYNC_TIMEOUT = 30000; // fetch block sync info timeout
export const DIFF = 5000;
...
export const TOKEN_LIST_PAGE_SIZE = 7;
...
export const DUSD_SYMBOL = '15';
export const TSLA_SYMBOL = '16';
export const BABA_SYMBOL = '19';
export const GME_SYMBOL = '20';
export const PLTR_SYMBOL = '21';
export const AAPL_SYMBOL = '22';
export const GOOGL_SYMBOL = '23';
export const ARKK_SYMBOL = '24';
export const SPY_SYMBOL = '26';
export const QQQ_SYMBOL = '27';
export const GLD_SYMBOL = '28';
export const SLV_SYMBOL = '29';
export const PDBC_SYMBOL = '30';
export const VNQ_SYMBOL = '31';
export const URTH_SYMBOL = '34';
export const TLT_SYMBOL = '37';
...
export const STATS_API_BLOCK_URL = `https://ocean.defichain.com/v0/`;
...
export const REFRESH_TESTPOOLSWAP_COUNTER = 30000;
